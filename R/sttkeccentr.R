#' @title Estimates the Eccentricity of a Statokinesigram.
#' @name sttkeccentr
#'
#' @description Computes the eccentricity of the confidence ellipse of a given statokinesigram.
#'
...
#'
#' @return The eccentricity of the given statokinesigram \code{eccentr}.
#'
#' @author Jose Magalhaes de Oliveira
#'
#' @seealso \code{\link[stabilo]{sttkangle}}, \code{\link[stabilo]{sttkarea}}
#'
#' @examples
...
#' COP <- data.frame(x, y)
#'
#' COPeccentr <- sttkeccentr(COP)
#'
#'
#' @export
sttkeccentr = function (dados) {
  invp <- 4.8955/2
